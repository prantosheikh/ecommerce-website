const NancyChair = () => {
  return (
    <div className="flex justify-around items-center gap-8 pt-[80px] px-[80px] mt-[80px]">
      <div className="w-1/2">
        <img
          onScroll="hover:scale-110"
          src="https://i.ibb.co/18jcdVz/nancy-chair.png"
          alt=""
        />
      </div>
      <div className="w-1/2">
        ...
        <h1 className="text-4xl my-2 font-bold cursor-pointer  hover:text-yellow-600 transition duration-300 transition-delay-500 ease-in-out relative group mb-6">
          Nancy Chair
